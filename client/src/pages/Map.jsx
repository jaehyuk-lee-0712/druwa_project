...
const Map = () => {
    ...
    return (
        <section className='map'>
            <div className={`top__ui__base ${mainMenu ? 'hide' : isSearch ? '' : 'hide'}`}>
                <div className="top__ui">
                    <div className="top__ui__table">
                        ...
                        <div className="top__table__search" onClick={toggleSearch}>
                            <input type="search" className='search__input' placeholder='검색어를 입력해주세요' />
            ...
            <div className={`top__ui__banner ${mainMenu ? 'hide' : isSearch ? '' : 'hide'}`}>
                    ...
                    <div className="autocomplete__result">
                        <div className="autocomplete__results">
                            ...
                            <div className="autocomplete__suggestion">
                                <div className="img"></div>
                                경상북도 김천시 부항면<strong className='st__blue'> 안</strong>간리
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div className={`map__menu ${mainMenu ? isSearch ? '' : 'hide' : 'hide'}`}>
                ...
                <div className={`map__contents ${mainMenu ? '' : 'hide'}`}>
                    ...
                    <div className="cont__scroll">
                        ...
                        <div className="cont__tabmenu">
                            <div className="tabmenu__btn" data-selected="false">Home</div>
                            <div className="tabmenu__btn" data-selected="true">매물</div>
                            <div className="tabmenu__btn" data-selected="false">경매</div>
                            <div className="tabmenu__btn" data-selected="false">포스트</div>
                        </div>
                            ...
                            <div className="cont__box__cont">
                                <article className='post__item'>
                                    ...
                                    <div className="post__item__text">
                                        <div className="title">[572] 내포 상가임대 / 병원입지상가 / 대로변코너 / 3층 50평 / 3층 50평</div>
                                        <div className="desc"> 충청남도 홍성군 홍북읍 신경리 상가 임대 충청남도 홍성군 홍북읍 신경리 상가 임대</div>
                                    </div>
                                </article>
                                <article className='post__item'>
                                    <div className="post__item__img"></div>
            ...
            <div className={`menu__header__mobile ${mainMenu ? 'hide' : isSearch ? '' : 'hide'}`}>
                <div className="top__ui">
                    <div className="menu__btn"></div>
                    <div className="top__logo">druwa</div>
